...
namespace Renderer
{
	...
	public:
		...
		{
			Opaque_BS = 0, AlphaBlend_BS, Additive_BS, NonPremultiplied_BS, COUNT_BS
		};
		...
		{
			PointWrap = 0, PointClamp, LinearWrap, LinearClamp, AnisotropicWrap, AnisotropicClamp,COUNT_SS
		};
