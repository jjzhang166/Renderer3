...
namespace Renderer
{
	...
	// Blend states.
	ID3D11BlendState* CCommonStateObjects::m_blendStates[COUNT_BS];
	// Depth stencil states.
	ID3D11DepthStencilState* CCommonStateObjects::m_depthStencilStates[COUNT_DSS];
	// Rasterizer states.
	ID3D11RasterizerState* CCommonStateObjects::m_rasterizerStates[COUNT_RS];
	// Sampler states.
	ID3D11SamplerState*  CCommonStateObjects::m_samplerStates[COUNT_SS];
	...
	CCommonStateObjects::CCommonStateObjects()
	{
		...
		CreateSamplerState(D3D11_FILTER_MIN_MAG_MIP_LINEAR, D3D11_TEXTURE_ADDRESS_WRAP, &m_samplerStates[LinearWrap]);
		CreateSamplerState(D3D11_FILTER_MIN_MAG_MIP_LINEAR, D3D11_TEXTURE_ADDRESS_CLAMP, &m_samplerStates[LinearClamp]);
